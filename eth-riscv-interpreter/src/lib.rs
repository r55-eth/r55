...
pub mod interpreter;
pub use interpreter::{RiscVInterpreter, InterpreterError};

// Re-export specific backends with proper feature gates
#[cfg(feature = "rvemu-backend")]
pub use interpreter::rvemu::RvEmuBackend;

#[cfg(feature = "unicorn-backend")]
pub use interpreter::unicorn::UnicornBackend;

// Existing rvemu-specific code should be feature-gated
#[cfg(feature = "rvemu-backend")]
mod rvemu_functions {
...
// Re-export the rvemu_functions at the crate root level
#[cfg(feature = "rvemu-backend")]
pub use rvemu_functions::setup_from_elf;

// Tests should also be feature-gated
#[cfg(all(test, feature = "rvemu-backend", feature = "std"))]
mod tests {
